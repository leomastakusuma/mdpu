...
class Zend_Auth_Adapter_Ldap implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * The username of the user-resource being authenticated.
     *
     * @var string
     */
    ...
    /**
     * The password of the user-resource being authenticated.
     *
     * @var string
     */
    ...
    /**
     * The DN of the authenticated user-resource. Used to retrieve the user-resource entry on request.
     *
     * @var string
     */
     ...
     * @param  string $username The username of the user-resource being authenticated
     * @param  string $password The password of the user-resource being authenticated
     * @return void
     */
    ...
    /**
     * Returns the username of the user-resource being authenticated, or
     * NULL if none is set.
     *
     * @return string|null
     */
    ...
    /**
     * Returns the password of the user-resource being authenticated, or
     * NULL if none is set.
     *
     * @return string|null
     */
    ...
    /**
     * Sets the passwort for the user-resource
     *
     * @param  string $password The password of the user-resource being authenticated
     * @return Zend_Auth_Adapter_Ldap Provides a fluent interface
     */
    ...
    public function authenticate()
    {
        ...
        foreach ($this->_options as $name => $options) {
            ...
            try {
                 ...
                 * group-membership information or own user-resource.
