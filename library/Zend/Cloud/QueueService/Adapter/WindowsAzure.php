    ...
    extends Zend_Cloud_QueueService_Adapter_AbstractAdapter
{
    ...
    public function __construct($options = array())
    {
        ...
        if (! isset($options[self::ACCOUNT_NAME])) {
            throw new Zend_Cloud_Storage_Exception('No Windows Azure user-resource name provided.');
        }
        if (! isset($options[self::ACCOUNT_KEY])) {
            throw new Zend_Cloud_Storage_Exception('No Windows Azure user-resource key provided.');
        }
        try {
