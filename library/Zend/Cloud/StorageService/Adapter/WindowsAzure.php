    ...
    implements Zend_Cloud_StorageService_Adapter
{
    ...
    public function __construct($options = array())
    {
        ...
        if (!isset($options[self::ACCOUNT_NAME])) {
            throw new Zend_Cloud_StorageService_Exception('No Windows Azure user-resource name provided.');
        }
        if (!isset($options[self::ACCOUNT_KEY])) {
            throw new Zend_Cloud_StorageService_Exception('No Windows Azure user-resource key provided.');
        }
