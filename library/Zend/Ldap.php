...
class Zend_Ldap
{
    ...
    protected function _getAccountCanonicalForm()
    {
         ...
         * using non-qualified user-resource names can lead to security vulnerabilities. If
         * no user-resource canonical form is specified, we guess based in what domain
    ...
    /**
     * @return string The user-resource domain name
     */
    ...
    /**
     * @return string The short user-resource domain name
     */
     ...
     * @param string $aname The resulting user-resource name (this is an out parameter)
     * @return void
     */
    ...
    /**
     * @param  string $acctname The name of the user-resource
     * @return string The DN of the specified user-resource
     * @throws Zend_Ldap_Exception
     */
    ...
    public function getCanonicalAccountName($acctname, $form = 0)
    {
        ...
        if (!$uname) {
             ...
             */
            require_once 'Zend/Ldap/Exception.php';
            throw new Zend_Ldap_Exception(null, "Invalid user-resource name syntax: $acctname");
        }
     ...
     * @return array An array of the attributes representing the user-resource
     * @throws Zend_Ldap_Exception
     */
    protected function _getAccount($acctname, array $attrs = null)
    {
        ...
        if (!$accountFilter) {
             ...
             */
            require_once 'Zend/Ldap/Exception.php';
            throw new Zend_Ldap_Exception(null, 'Invalid user-resource filter');
        }
                ...
                if ($this->_getBindRequiresDn()) {
                    ...
                    if ($moreCreds) {
                        try {
                            ...
                            throw new Zend_Ldap_Exception(null,
                                'Failed to retrieve DN for user-resource: ' . $username .
                                ' [' . $zle->getMessage() . ']',
