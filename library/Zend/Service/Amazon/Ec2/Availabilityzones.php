...
/**
 * An Amazon EC2 interface to query which Availibity Zones your user-resource has access to.
 *
 * @category   Zend
 * @package    Zend_Service_Amazon
 * @subpackage Ec2
...
{
    /**
     * Describes availability zones that are currently available to the user-resource
     * and their states.
     *
