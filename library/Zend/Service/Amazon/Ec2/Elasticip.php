...
{
    /**
     * Acquires an elastic IP address for use with your user-resource
     *
    ...
    /**
     * Lists elastic IP addresses assigned to your user-resource.
     *
    ...
    /**
     * Releases an elastic IP address that is associated with your user-resource
     *
     * @param string $publicIp                  IP address that you are releasing from your user-resource.
     * @return boolean
     */
