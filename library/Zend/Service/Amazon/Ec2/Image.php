...
class Zend_Service_Amazon_Ec2_Image extends Zend_Service_Amazon_Ec2_Abstract
{
     ...
     * which you have access are returned. The results can include the user-resource IDs of the
     ...
     * for the AMIs are returned. You can specify user-resource IDs (if you own the AMI(s)), self
