...
class Zend_Service_WindowsAzure_Management_Client
{
	...
	/**
	 * Creates a new Zend_Service_WindowsAzure_Storage_Blob instance for the current user-resource
	 *
	...
	/**
	 * Creates a new Zend_Service_WindowsAzure_Storage_Table instance for the current user-resource
	 *
	 * @param string $serviceName the service name to create a storage client for.
	 * @param Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy Retry policy to use when making requests
	...
	/**
	 * Creates a new Zend_Service_WindowsAzure_Storage_Queue instance for the current user-resource
	 *
	 * @param string $serviceName the service name to create a storage client for.
	 * @param Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy Retry policy to use when making requests
     ...
     * specified storage user-resource. These properties include: the address, description, and
     * label of the storage user-resource; and the name of the affinity group to which the service
     ...
     * and secondary access keys for the specified storage user-resource.
     *
     * @param string $serviceName The name of your service.
     ...
     * or secondary access key for the specified storage user-resource.
     *
     * @param string $serviceName The name of your service.
	 ...
	 * @param string $label             A URL that refers to the location of the service package in the Blob service. The service package must be located in a storage user-resource beneath the same subscription.
